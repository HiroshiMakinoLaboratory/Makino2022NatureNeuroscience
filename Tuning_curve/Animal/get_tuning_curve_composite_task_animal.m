function get_tuning_curve_composite_task_animal(learning_stage)
...
for animal_num = 1:numel(activity_composite_task_pretraining)
    clearvars -except learning_stage activity_composite_task_pretraining animal_num tuning_composite_task
    ...
    GLM = activity_composite_task_pretraining{animal_num}{session_num};
    ...
    lick_onset_idx = 209:214;
    reward_onset_idx = 215:223;
    ...
    for region_num = region_num_temp:region
        ...
        lick_onset_cell_idx_temp2{region_num} = find(contribution_matrix{region_num}(:,6));
        reward_onset_cell_idx_temp2{region_num} = find(contribution_matrix{region_num}(:,7));
    ...
    tuning_composite_task.pretraining{animal_num} = tuning_animal;
end
