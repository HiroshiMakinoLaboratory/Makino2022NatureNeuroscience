function get_action_value_cell_composite_task_agent
...
% Load 'tuning_composite_task' after running 'get_tuning_curve_composite_task_agent.m' for the 'late' stage.

load('agent_behavior_composite_task.mat')
load('agent_activity_composite_task.mat')

for seed_num = 1:6
    clearvars -except behavior_composite_task activity_composite_task tuning_composite_task seed_num action_value_cell_composite_task
    ...
    q_input = activity_composite_task.pretraining{seed_num}.late.q_input;
    q_task1_network_first_layer = activity_composite_task.pretraining{seed_num}.late.q_task1_network_first_layer;
    q_task1_network_second_layer = activity_composite_task.pretraining{seed_num}.late.q_task1_network_second_layer;
    q_task1_network_third_layer = activity_composite_task.pretraining{seed_num}.late.q_task1_network_third_layer;
    q_task2_network_first_layer = activity_composite_task.pretraining{seed_num}.late.q_task2_network_first_layer;
    q_task2_network_second_layer = activity_composite_task.pretraining{seed_num}.late.q_task2_network_second_layer;
    q_task2_network_third_layer = activity_composite_task.pretraining{seed_num}.late.q_task2_network_third_layer;
    ...
    % Get action-value function for Composite task.
    clearvars -except behavior_composite_task activity_composite_task tuning_composite_task seed_num ...
        ...
        gamma filtered_value_function action_value_cell_composite_task
    ...
    clearvars -except behavior_composite_task activity_composite_task tuning_composite_task seed_num ...
        q_input q_task1_network_first_layer q_task1_network_second_layer q_task1_network_third_layer q_task2_network_first_layer q_task2_network_second_layer q_task2_network_third_layer ...
        filtered_value_function action_value_function action_value_cell_composite_task
    ...
    action_value_cell_composite_task{seed_num}.action_value_function = action_value_function;
    action_value_cell_composite_task{seed_num}.movement_task1_network = mean_action_dist_active_bins_all_movement_task1;
    action_value_cell_composite_task{seed_num}.movement_task2_network = mean_action_dist_active_bins_all_movement_task2;
    action_value_cell_composite_task{seed_num}.lick_task1_network = mean_action_dist_active_bins_all_lick_task1;
    action_value_cell_composite_task{seed_num}.lick_task2_network = mean_action_dist_active_bins_all_lick_task2;
    action_value_cell_composite_task{seed_num}.correlation_agent_movement_task1 = correlation_movement_task1;
    action_value_cell_composite_task{seed_num}.dot_product_agent_movement_task1 = dot_product_movement_task1;
    action_value_cell_composite_task{seed_num}.correlation_agent_movement_task2 = correlation_movement_task2;
    action_value_cell_composite_task{seed_num}.dot_product_agent_movement_task2 = dot_product_movement_task2;
    action_value_cell_composite_task{seed_num}.dot_product_lick_task1 = dot_product_lick_task1;
    action_value_cell_composite_task{seed_num}.correlation_lick_task1 = correlation_lick_task1;
    action_value_cell_composite_task{seed_num}.dot_product_lick_task2 = dot_product_lick_task2;
    action_value_cell_composite_task{seed_num}.correlation_lick_task2 = correlation_lick_task2;
    action_value_cell_composite_task{seed_num}.correlation_agent_position_task1 = correlation_agent_position_task1;
    action_value_cell_composite_task{seed_num}.correlation_agent_position_task2 = correlation_agent_position_task2;
end
